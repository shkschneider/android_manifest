...
* **Android: 6.0.1** [android-6.0.1_r54](https://source.android.com/source/build-numbers.html#source-code-tags-and-builds)
...
<pre>$ repo init --config-name -u https://android.googlesource.com/platform/manifest -b android-6.0.1_r54</pre>
